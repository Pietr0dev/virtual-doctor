      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid gap-8 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-heavy text-lg text-white leading-none block">doctor</span>
                <span className="text-semibold-italic text-sm text-primary leading-none block">virtual</span>
              </div>
            </div>
            <p className="text-gray-300 text-sm max-w-md leading-relaxed">
              Transformamos el acceso a la salud pública y privada a través de nuestra plataforma de telemedicina white-label.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-white mb-4">Sectores</h3>
            <ul className="space-y-3">
              {[
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Doctor Virtual S.A. Todos los derechos reservados.
          </p>
